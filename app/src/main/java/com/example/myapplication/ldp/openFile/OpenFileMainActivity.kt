...
import com.example.myapplication.databinding.ActivityOpenFileMainBinding

class OpenFileMainActivity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityOpenFileMainBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOpenFileMainBinding.inflate(layoutInflater)
