package com.example.myapplication.ldp.sqlite
...
import com.example.myapplication.databinding.ActivitySqlLiteMainBinding
...
class SqlLiteMainActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySqlLiteMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySqlLiteMainBinding.inflate(layoutInflater)
        ...
        adapter = NoteAdapter(object : NoteAdapter.OnItemClickCallback {
            override fun onItemClicked(selectedNote: Note?, position: Int?) {
                val intent = Intent(this@SqlLiteMainActivity, NoteAddUpdateActivity::class.java)
