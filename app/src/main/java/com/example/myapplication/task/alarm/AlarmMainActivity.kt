package com.example.myapplication.task.alarm
...
import com.example.myapplication.databinding.ActivityAlarmMainBinding
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class AlarmMainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {

    private var binding: ActivityAlarmMainBinding? = null
