...
class OptionDialogFragment : DialogFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnChoose.setOnClickListener {
            val checkRadioButton = rgOptions.checkedRadioButtonId
            if(checkRadioButton != -1){
                val coach : String? = when(checkRadioButton){
    ...
    override fun onAttach(context: Context) {
        ...
        if(fragmentManager is DetailCategoryFragment){
            this.optionDialogListener = fragmentManager.optionDialogListener
        }
    }
